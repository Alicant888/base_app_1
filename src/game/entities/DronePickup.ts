...
export class DronePickup extends Phaser.Physics.Arcade.Sprite {
  constructor(scene: Phaser.Scene, x: number, y: number) {
    super(
      ...
      y,
      ATLAS_KEYS.fx3,
      `${SPRITE_FRAMES.dronePickupPrefix}${SPRITE_FRAMES.dronePickupStart}${SPRITE_FRAMES.dronePickupSuffix}`,
    );
